  ...
  <>
    <div className='d-flex py-2 px-3 border border-danger justify-content-between align-items-center'>
      <div className='d-flex justify-content-between align-items-center'>
        ...
        <h2 className='mx-2' >I am a babe Monkey... at the temple!!!</h2>
      </div>
...
const Hero = () => {
  ...
  <div
    ...
    style={{ backgroundImage: "url('https://memorableindia.com/blog/wp-content/uploads/2019/11/Monkey-Temple-in-Jaipur.jpg')", height: 450 }}
      >
      <div className='mask' style={{ height: '100%', width: '100%', backgroundColor: 'rgba(0, 0, 0, 0.45)' }}>
        <div className='d-flex justify-content-center align-items-center h-100'>
          <div className='text-white'>
            <h1 className='mb-3'>Monkey temple</h1>
            <h4 className='mb-3'>Jaipur</h4>
...
const Footer = () => {
  ...
  <div  className="text-center p-3" style={{backgroundColor: "rgba(0, 0, 0, 0.2)"}}>
    © 2023 Copyright:&nbsp;
    <a  className="text-dark" href="#!">MyMonkey.com</a>
  </div>
